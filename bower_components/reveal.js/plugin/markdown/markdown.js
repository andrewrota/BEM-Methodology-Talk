		...
		for( var i = 0, len = sections.length; i < len; i++ ) {
			...
			if( section.getAttribute( 'data-markdown' ).length ) {
				...
				try {
					...
					console.log( 'Failed to get the Markdown file ' + url + '. Make sure that the presentation and the file are served by a HTTP server and the file can be found there. ' + e );
				}
